...
* **Analytics Preditiva (O que Pode Acontecer?):**
    ...
    * **O Foco:** Usar dados históricos para prever o futuro. Identificar probabilidades e tendências futuras.
...
###   1.  Coletar Dados
    ...
    `dados_brutos = obter_dados_de_algum_lugar()`
